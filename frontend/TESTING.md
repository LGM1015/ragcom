...
## 问题：No static resource api/ragcom/knowledge-base
...
#### 1. 确认后端服务运行
```bash
curl http://localhost:8080/api/ragcom/knowledge-base
...
#### 2. 重启前端开发服务器
```bash
cd /Users/machen/workspace/ragcom/ragcom/frontend
...
| 前端请求 | 代理后 | 后端实际路径 |
|---------|--------|-------------|
| /api/ragcom/knowledge-base | http://localhost:8080/api/ragcom/knowledge-base | /knowledge-base (context-path已包含/api/ragcom) |
...
**正常情况：**
- Request URL: http://localhost:5173/api/ragcom/knowledge-base
