...
package com.lgm1015.ragcom.knowledge.service.impl;
...
import com.lgm1015.ragcom.core.chunk.ChunkEmbeddingService;
import com.lgm1015.ragcom.core.chunk.ChunkingMode;
import com.lgm1015.ragcom.core.chunk.ChunkingOptions;
import com.lgm1015.ragcom.core.chunk.ChunkingStrategy;
import com.lgm1015.ragcom.core.chunk.ChunkingStrategyFactory;
import com.lgm1015.ragcom.core.chunk.VectorChunk;
import com.lgm1015.ragcom.core.parser.DocumentParserSelector;
import com.lgm1015.ragcom.core.parser.ParserType;
import com.lgm1015.ragcom.framework.context.UserContext;
import com.lgm1015.ragcom.framework.exception.ClientException;
import com.lgm1015.ragcom.framework.mq.producer.MessageQueueProducer;
import com.lgm1015.ragcom.ingestion.dao.entity.IngestionPipelineDO;
import com.lgm1015.ragcom.ingestion.dao.mapper.IngestionPipelineMapper;
import com.lgm1015.ragcom.ingestion.domain.context.IngestionContext;
import com.lgm1015.ragcom.ingestion.domain.pipeline.PipelineDefinition;
import com.lgm1015.ragcom.ingestion.engine.IngestionEngine;
import com.lgm1015.ragcom.ingestion.service.IngestionPipelineService;
import com.lgm1015.ragcom.knowledge.config.KnowledgeScheduleProperties;
import com.lgm1015.ragcom.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.lgm1015.ragcom.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.lgm1015.ragcom.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.lgm1015.ragcom.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.lgm1015.ragcom.knowledge.controller.vo.KnowledgeChunkVO;
import com.lgm1015.ragcom.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.lgm1015.ragcom.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.lgm1015.ragcom.knowledge.controller.vo.KnowledgeDocumentVO;
import com.lgm1015.ragcom.knowledge.dao.entity.KnowledgeBaseDO;
import com.lgm1015.ragcom.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
import com.lgm1015.ragcom.knowledge.dao.entity.KnowledgeDocumentDO;
import com.lgm1015.ragcom.knowledge.dao.mapper.KnowledgeBaseMapper;
import com.lgm1015.ragcom.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.lgm1015.ragcom.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.lgm1015.ragcom.knowledge.enums.DocumentStatus;
import com.lgm1015.ragcom.knowledge.enums.ProcessMode;
import com.lgm1015.ragcom.knowledge.enums.SourceType;
import com.lgm1015.ragcom.knowledge.handler.RemoteFileFetcher;
import com.lgm1015.ragcom.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.lgm1015.ragcom.knowledge.schedule.CronScheduleHelper;
import com.lgm1015.ragcom.knowledge.service.KnowledgeChunkService;
import com.lgm1015.ragcom.knowledge.service.KnowledgeDocumentScheduleService;
import com.lgm1015.ragcom.knowledge.service.KnowledgeDocumentService;
import com.lgm1015.ragcom.rag.core.vector.VectorSpaceId;
import com.lgm1015.ragcom.rag.core.vector.VectorStoreService;
import com.lgm1015.ragcom.rag.dto.StoredFileDTO;
import com.lgm1015.ragcom.rag.service.FileStorageService;
